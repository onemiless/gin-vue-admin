<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="工艺卡编号" prop="processCardNumber">
         <el-input v-model="searchInfo.processCardNumber" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="工艺卡编号" prop="processCardNumber" width="120" />
        <el-table-column align="left" label="工艺卡流水号" prop="processCardSN" width="120" />
         <el-table-column align="left" label="工艺卡最新日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.latestDate) }}</template>
         </el-table-column>
        <el-table-column align="left" label="工艺卡版本号" prop="versionNumber" width="120" />
        <el-table-column align="left" label="工艺卡入篮量" prop="baskets" width="120" />
        <el-table-column align="left" label="工艺卡节拍" prop="beat" width="120" />
        <el-table-column align="left" label="工艺卡产能" prop="productionCapacity" width="120" />
        <el-table-column align="left" label="PDF编号" prop="PDFSN" width="120" />
         <el-table-column align="left" label="PFD建立日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.PDFCreateDate) }}</template>
         </el-table-column>
         <el-table-column align="left" label="PDF最新日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.PDFLatestDate) }}</template>
         </el-table-column>
        <el-table-column align="left" label="PDF版本号" prop="PDFVN" width="120" />
        <el-table-column align="left" label="PFMEA编号" prop="PFMEASN" width="120" />
         <el-table-column align="left" label="PFMEA建立日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.PFMEACreateDate) }}</template>
         </el-table-column>
         <el-table-column align="left" label="PFMEA最新日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.PFMEALatestDate) }}</template>
         </el-table-column>
        <el-table-column align="left" label="PFMEA版本号" prop="PFMEAVN" width="120" />
        <el-table-column align="left" label="CP编号" prop="CPSN" width="120" />
         <el-table-column align="left" label="CP建立日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.CPCreateDate) }}</template>
         </el-table-column>
         <el-table-column align="left" label="CP最新日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.CPLatestDate) }}</template>
         </el-table-column>
        <el-table-column align="left" label="CP版本号" prop="CPSV" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateProcessFileInformationFunc(scope.row)">变更</el-button>
        ...
        <el-form-item label="唯一追踪号:" prop="UTN">
          ...
          >
            ...
            <el-form-item label="工艺卡流水号:"  prop="processCardSN" >
              <el-input v-model.number="formData.processCardSN" :clearable="true" placeholder="请输入工艺卡流水号" />
            </el-form-item>
            <el-form-item label="工艺卡最新日期:"  prop="latestDate" >
              <el-date-picker v-model="formData.latestDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="工艺卡入篮量:"  prop="baskets" >
              <el-input-number v-model="formData.baskets"  style="width:100%" :precision="3" :clearable="true"  />
            </el-form-item>
            <el-form-item label="工艺卡节拍:"  prop="beat" >
              <el-input-number v-model="formData.beat"  style="width:100%" :precision="3" :clearable="true"  />
            </el-form-item>
            <el-form-item label="工艺卡产能:"  prop="productionCapacity" >
              <el-input-number v-model="formData.productionCapacity"  style="width:100%" :precision="3" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="PFD建立日期:"  prop="PDFCreateDate" >
              <el-date-picker v-model="formData.PDFCreateDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            <el-form-item label="PDF最新日期:"  prop="PDFLatestDate" >
              <el-date-picker v-model="formData.PDFLatestDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="PFMEA建立日期:"  prop="PFMEACreateDate" >
              <el-date-picker v-model="formData.PFMEACreateDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            <el-form-item label="PFMEA最新日期:"  prop="PFMEALatestDate" >
              <el-date-picker v-model="formData.PFMEALatestDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="CP建立日期:"  prop="CPCreateDate" >
              <el-date-picker v-model="formData.CPCreateDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            <el-form-item label="CP最新日期:"  prop="CPLatestDate" >
              <el-date-picker v-model="formData.CPLatestDate" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
...
const getTableData = async() => {
  const table = await getProcessFileInformationList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
