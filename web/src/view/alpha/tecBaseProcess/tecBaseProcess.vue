  ...
  <div>
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" title="查看详情" destroy-on-close>
        ...
        <el-descriptions :column="1" border>
                <el-descriptions-item label="主ID">
                        {{ formData.parenId }}
                </el-descriptions-item>
                <el-descriptions-item label="工艺方式">
                        {{ filterDict(formData.processType,工艺方式Options) }}
                </el-descriptions-item>
                <el-descriptions-item label="除油">
                        {{ filterDict(formData.unoil,除油Options) }}
                </el-descriptions-item>
                <el-descriptions-item label="抛丸">
                        {{ filterDict(formData.shotBlasting,抛丸Options) }}
                </el-descriptions-item>
                <el-descriptions-item label="磷化">
                        {{ filterDict(formData.phosphat,磷化Options) }}
                </el-descriptions-item>
                <el-descriptions-item label="电镀">
                        {{ filterDict(formData.electroplate,电镀Options) }}
                </el-descriptions-item>
