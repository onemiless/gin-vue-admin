<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
           ...
           <el-form-item label="分部" prop="ME002">
            <el-select v-model="searchInfo.ME002" clearable placeholder="请选择" @clear="()=>{searchInfo.ME002=undefined}">
        ...
        <el-form-item label="零件类型2" prop="typeext">
             ...
             <el-input v-model.number="searchInfo.typeext" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="零件类型1" prop="type" width="120" />
        <el-table-column align="left" label="零件类型2" prop="typeext" width="120" />
        <el-table-column align="left" label="客户名称" prop="MB201" width="120" />
        <el-table-column align="left" label="零件名称" prop="MB002" width="120" />
        <el-table-column align="left" label="客户品号" prop="MB202" width="120" />
        <el-table-column align="left" label="零件规格" prop="MB003" width="120" />
        <el-table-column align="left" label="零件图号" prop="figureNumber" width="120" />
        <el-table-column align="left" label="计价单位" prop="MB004" width="120" />
        <el-table-column align="left" label="唯一追踪号" prop="UTN" width="120" />
        <el-table-column align="left" label="材质" prop="textrue" width="120" />
        <el-table-column align="left" label="硬度/机械等级" prop="level" width="120" />
        ...
        <el-table-column align="left" label="最大直径" prop="diameter" width="120" />
        <el-table-column align="left" label="料厚" prop="thick" width="120" />
        <el-table-column align="left" label="线径" prop="wireDiameter" width="120" />
        <el-table-column align="left" label="单重" prop="pieceWeight" width="120" />
        <el-table-column align="left" label="表面积" prop="BET" width="120" />
        <el-table-column align="left" label="图纸" prop="graphPaper" width="120" />
        <el-table-column align="left" label="图纸日期或版本" prop="GPDateOrVersion" width="120" />
        <el-table-column align="left" label="图纸评审" prop="GPAudit" width="120" />
        <el-table-column align="left" label="主机厂" prop="OE" width="120" />
        <el-table-column align="left" label="车厂标准代号" prop="OEMStandCode" width="120" />
        <el-table-column align="left" label="车厂标准" prop="OEMStand" width="120" />
        <el-table-column align="left" label="车厂标准评审" prop="OEMStandardReview" width="120" />
        <el-table-column align="left" label="工艺、设备及治具基本信息" prop="technique" width="120" />
        <el-table-column align="left" label="表面处理信息" prop="surfaceInfo" width="120" />
        <el-table-column align="left" label="质量要求信息" prop="qualityInfo" width="120" />
        <el-table-column align="left" label="成本信息收集信息" prop="coastInfo" width="120" />
        <el-table-column align="left" label="产品导入信息" prop="importInfo" width="120" />
        <el-table-column align="left" label="工艺文件信息" prop="processInfo" width="120" />
        <el-table-column align="left" label="量产转移信息" prop="transferInformation" width="120" />
        <el-table-column align="left" label="工程变更信息" prop="changeInfo" width="120" />
        <el-table-column align="left" label="包装要求" prop="packageInfo" width="120" />
        <el-table-column align="left" label="效率相关信息" prop="productivityInfo" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateTecBaseInfoFunc(scope.row)">变更</el-button>
    ...
    <el-drawer size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #title>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="零件规格:"  prop="MB003" >
              <el-input v-model="formData.MB003" :clearable="true"  placeholder="请输入零件规格" />
            </el-form-item>
            <el-form-item label="零件图号:"  prop="figureNumber" >
              <el-input v-model="formData.figureNumber" :clearable="true"  placeholder="请输入零件图号" />
            </el-form-item>
            ...
            <el-form-item label="材质:"  prop="textrue" >
              <el-input v-model="formData.textrue" :clearable="true"  placeholder="请输入材质" />
            </el-form-item>
            <el-form-item label="硬度/机械等级:"  prop="level" >
              <el-input v-model="formData.level" :clearable="true"  placeholder="请输入硬度/机械等级" />
            </el-form-item>
            <el-form-item label="长:"  prop="length" >
              <el-input-number v-model="formData.length"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="最大直径:"  prop="diameter" >
              <el-input-number v-model="formData.diameter"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            <el-form-item label="料厚:"  prop="thick" >
              <el-input-number v-model="formData.thick"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            <el-form-item label="线径:"  prop="wireDiameter" >
              <el-input-number v-model="formData.wireDiameter"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            <el-form-item label="单重:"  prop="pieceWeight" >
              <el-input-number v-model="formData.pieceWeight"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            ...
            <el-form-item label="图纸评审:"  prop="GPAudit" >
              <el-input v-model="formData.GPAudit" :clearable="true"  placeholder="请输入图纸评审" />
            </el-form-item>
            <el-form-item label="主机厂:"  prop="OE" >
            ...
            <el-form-item label="车厂标准:"  prop="OEMStand" >
              <el-input v-model="formData.OEMStand" :clearable="true"  placeholder="请输入车厂标准" />
            </el-form-item>
            <el-form-item label="车厂标准评审:"  prop="OEMStandardReview" >
              <el-input v-model="formData.OEMStandardReview" :clearable="true"  placeholder="请输入车厂标准评审" />
            </el-form-item>
            <el-form-item label="工艺、设备及治具基本信息:"  prop="technique" >
              <el-input v-model.number="formData.technique" :clearable="true" placeholder="请输入工艺、设备及治具基本信息" />
            </el-form-item>
            <el-form-item label="表面处理信息:"  prop="surfaceInfo" >
              <el-input v-model.number="formData.surfaceInfo" :clearable="true" placeholder="请输入表面处理信息" />
            </el-form-item>
            <el-form-item label="质量要求信息:"  prop="qualityInfo" >
              <el-input v-model.number="formData.qualityInfo" :clearable="true" placeholder="请输入质量要求信息" />
            </el-form-item>
            <el-form-item label="成本信息收集信息:"  prop="coastInfo" >
              <el-input v-model.number="formData.coastInfo" :clearable="true" placeholder="请输入成本信息收集信息" />
            </el-form-item>
            <el-form-item label="产品导入信息:"  prop="importInfo" >
              <el-input v-model.number="formData.importInfo" :clearable="true" placeholder="请输入产品导入信息" />
            </el-form-item>
            <el-form-item label="工艺文件信息:"  prop="processInfo" >
              <el-input v-model.number="formData.processInfo" :clearable="true" placeholder="请输入工艺文件信息" />
            </el-form-item>
            <el-form-item label="量产转移信息:"  prop="transferInformation" >
              <el-input v-model.number="formData.transferInformation" :clearable="true" placeholder="请输入量产转移信息" />
            </el-form-item>
            <el-form-item label="工程变更信息:"  prop="changeInfo" >
              <el-input v-model.number="formData.changeInfo" :clearable="true" placeholder="请输入工程变更信息" />
            </el-form-item>
            <el-form-item label="包装要求:"  prop="packageInfo" >
              <el-input v-model.number="formData.packageInfo" :clearable="true" placeholder="请输入包装要求" />
            </el-form-item>
            <el-form-item label="效率相关信息:"  prop="productivityInfo" >
              <el-input v-model.number="formData.productivityInfo" :clearable="true" placeholder="请输入效率相关信息" />
            </el-form-item>
          </el-form>
    </el-drawer>
...
const getTableData = async() => {
  const table = await getTecBaseInfoList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
