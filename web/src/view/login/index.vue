  ...
  >
    ...
    >
      <div class=" h-full flex items-center justify-evenly">
        ...
        <!-- 分割斜块 -->
        <div class="z-[999] pt-40 pb-10 md:w-96 w-full  rounded-lg flex flex-col justify-between box-border">
          ...
          <div>
            ...
            <div class="mb-9">
              ...
              <p class="text-center text-sm font-normal text-gray-500 mt-2.5">Alpha Mes platform
              </p>
            </div>
            <el-form
              ref="loginForm"
